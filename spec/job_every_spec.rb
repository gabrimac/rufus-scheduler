...
#  end
  ...
  it 'lets its @next_time change in-flight' do
    ...
    expect(times[1] - times[0]).to be > 0.89
    expect(times[1] - times[0]).to be < 1.40
    expect(times[2] - times[1]).to be > 3.00
    expect(times[2] - times[1]).to be < 3.40
  end
  ...
  describe '#next_times' do
    ...
    it 'takes first_at/in into account' do
      ...
      job = @scheduler.schedule_every '5m', first_in: 3 do; end
  ...
  describe '#next_times_until' do
    ...
    it 'takes first_at/in into account' do
      ...
      job = @scheduler.schedule_every '5m', first_in: '3s' do; end
